...
content_table.write("<head><link rel=\"stylesheet\" href=\"main.css\"></head>\n")
...
for source_file in sources_json:
    ...
    for ln in line_json:
        ...
        "lit. meaning", "root", "base", "construction", "compound type", "compound construction"]].fillna("")
            file.write("<div style=\"overflow-x:auto;\">\n")
            file.write(define_df.to_html(justify='left', index=False).replace("bhikkhupātimokkhapāḷi", "pāḷi").replace("0", ""))
            file.write("</div>\n")
            file.write("<br><br>\n")

    file.write("<script src=\"../main.js\"></script>\n") 
    file.write("</body>\n")
    file.write("</html>\n") 
    file.close()